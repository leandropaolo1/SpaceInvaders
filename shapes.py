    ...
    def collision(self, image):
        ...
        for contour in contours:
            ...
            if len(approx) == 3:
                ...
                triangle_position = triangle_vertices

            elif len(approx) == 4:
                x, y, w, h = cv2.boundingRect(contour)
                rectangle_positions.append(((x, y), (x + w, y), (x, y + h), (x + w, y + h)))
        ...
        for rect_corners in rectangle_positions:
            top_left, top_right, bottom_left, bottom_right = rect_corners
            time_to_collision = (max(triangle_position, key=lambda t: t[1])[1] - top_left[1]) / self.speed
            ...
            triangle_x_positions = [vert[0] for vert in triangle_position]
